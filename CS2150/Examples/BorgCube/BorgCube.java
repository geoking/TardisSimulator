...
public class BorgCube extends GraphicsLab
{
    ...
    private void drawUnitCube()
    {
        ...
        Vertex v1 = new Vertex(-0.5f, -0.8f,  0.5f);
        Vertex v2 = new Vertex(-0.5f,  0.8f,  0.5f);
        Vertex v3 = new Vertex( 0.5f,  0.8f,  0.5f);
        Vertex v4 = new Vertex( 0.5f, -0.8f,  0.5f);
        Vertex v5 = new Vertex(-0.5f, -0.8f, -0.5f);
        Vertex v6 = new Vertex(-0.5f,  0.8f, -0.5f);
        Vertex v7 = new Vertex( 0.5f,  0.8f, -0.5f);
        Vertex v8 = new Vertex( 0.5f, -0.8f, -0.5f);
